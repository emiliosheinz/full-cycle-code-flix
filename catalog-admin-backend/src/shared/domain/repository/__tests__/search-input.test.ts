...
import type { SearchParamsConstructorProps, SortDirection } from '../search-input';
...
describe('SearchInput', () => {
  ...
  test('should set filter to null when filter is not provided', () => { const searchInput = new SearchInput({});
    expect(searchInput.filter).toBeNull();
  });
});
